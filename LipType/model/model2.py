...
from lipnet.SE_ResNet import SEResNet34
...
class LipNet(object):
    ...
    def build(self):
        ...
        self.conv2 = SEResNet34(input_shape=None, width=1, bottleneck=False, weight_decay=1e-4).(self.zero2)
        ...
        self.resh1 = TimeDistributed(Flatten())(self.maxp2)
